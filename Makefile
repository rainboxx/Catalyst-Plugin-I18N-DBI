# This Makefile is for the Catalyst::Plugin::I18N::DBI extension to perl.
#
...
#     EXE_FILES => []
#     INSTALLDIRS => q[site]
#     NAME => q[Catalyst::Plugin::I18N::DBI]
#     PL_FILES => {  }
#     PREREQ_PM => { version=>q[0], NEXT=>q[0], Test::More=>q[0], I18N::LangTags::Detect=>q[0], Locale::Maketext::Lexicon::DBI=>q[0.2.0], I18N::LangTags=>q[0], Locale::Maketext=>q[0], Task::Weaken=>q[0], DBI=>q[0] }
#     VERSION_FROM => q[lib/Catalyst/Plugin/I18N/DBI.pm]
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = Catalyst::Plugin::I18N::DBI
NAME_SYM = Catalyst_Plugin_I18N_DBI
VERSION = 0.2.5_01
VERSION_MACRO = VERSION
VERSION_SYM = 0_2_5_01
...
MAKE = make
FULLEXT = Catalyst/Plugin/I18N/DBI
BASEEXT = DBI
PARENT_NAME = Catalyst::Plugin::I18N
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Catalyst/Plugin/I18N/DBI.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Catalyst/Plugin/I18N/DBI.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Catalyst/Plugin/I18N
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Catalyst/Plugin/I18N
...
TO_INST_PM = lib/Catalyst/Plugin/I18N/DBI.pm

PM_TO_BLIB = lib/Catalyst/Plugin/I18N/DBI.pm \
...
DISTNAME = Catalyst-Plugin-I18N-DBI
DISTVNAME = Catalyst-Plugin-I18N-DBI-0.2.5_01
...
manifypods : pure_all  \
	lib/Catalyst/Plugin/I18N/DBI.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Catalyst/Plugin/I18N/DBI.pm $(INST_MAN3DIR)/Catalyst::Plugin::I18N::DBI.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Catalyst-Plugin-I18N-DBI' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.2.5_01' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '    I18N::LangTags:       0' >> META_new.yml
	$(NOECHO) $(ECHO) '    I18N::LangTags::Detect:  0' >> META_new.yml
	$(NOECHO) $(ECHO) '    Locale::Maketext:     0' >> META_new.yml
	$(NOECHO) $(ECHO) '    Locale::Maketext::Lexicon::DBI:  0.2.0' >> META_new.yml
	$(NOECHO) $(ECHO) '    NEXT:                 0' >> META_new.yml
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0.2.5_01">' > $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT></ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR></AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="DBI::" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="I18N::LangTags" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="I18N::LangTags::Detect" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Locale::Maketext" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Locale::Maketext::Lexicon::DBI" VERSION="0.2" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="NEXT::" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Catalyst/Plugin/I18N/DBI.pm blib/lib/Catalyst/Plugin/I18N/DBI.pm 
